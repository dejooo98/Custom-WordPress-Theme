<?php
/**
 * Template part for displaying top blogs 
 *
...
<?php
    $recent_posts = wp_get_recent_posts(array(
     ...
     foreach( $recent_posts as $post_item ) : ?>
                            <article class="blogs-article col-md-12">
                                <!-- ARTICLE IMAGE -->
                                <a class="blogs-article__image" href="<?php echo get_permalink($post_item['ID']) ?>">
                                        <?php
